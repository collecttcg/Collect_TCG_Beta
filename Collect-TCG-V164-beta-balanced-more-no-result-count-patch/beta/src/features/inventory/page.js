...
function inventoryPageHTML(scopeMeta,scope){
    ...
    return `
      ...
      ${!isCollection ? `
        <div class="inventory-mobile-compact-result inventory-mobile-currency-only">
          <label class="mobile-page-currency-control mobile-results-currency" title="Choose which stored currency is shown first. No currency conversion is performed.">
            <span>Currency</span>
