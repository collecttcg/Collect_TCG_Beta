    ...
    function draw(){
      ...
      if(appContext.activeQuickFilter==="trending" && appContext.trending7dBackendState!=="available"){
        ...
        if(appContext.trending7dBackendState==="error"){
          ...
          grid.innerHTML=`<div class="empty-state inventory-no-results"><div class="empty-icon">↗</div><h3>Trending is temporarily unavailable</h3><p>We could not load the last 7 days of card performance. Please try Trending again shortly.</p></div>`;
        }else{
